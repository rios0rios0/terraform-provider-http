...
func GetHTTPRequestResourceSchema() schema.Schema {
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			// state
			// Import documentation with examples needs improvement
...
func (it *HTTPRequestResource) Read(
	...
	// Read method implementation for drift detection planned - see GitHub issue for Read method implementation
	var model HTTPRequestResourceModel
